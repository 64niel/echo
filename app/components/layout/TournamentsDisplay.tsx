...
import { getStarCount } from "../functions/StarCount"
import { getImagePathForGame } from "../functions/ImagePaths";
  ...
  return (
    ...
    <div className='flex flex-wrap justify-center mt-2 md:mt-3 mb-2 mb:mb-3'>
      ...
      {tournamentData.length === 0 ? (
        <div className='text-center tesxt-lg sm:text-xl w-[80%] m-2 mt-2 p-2 bg-carditembackground'>
